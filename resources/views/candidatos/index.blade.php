<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg py-7">
                ...
                <div class="md:flex md:justify-center p-5">
                    <ul class="divide-y divide-gray-200 w-full">
                        @forelse ($vacante->candidatos as $candidato)
                            <li class="p-3 flex items-center">
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm font-medium text-gray-600">Tiempo desde la postulación:
                        ...
                        @empty
                            <p class="p-3 text-center text-sm text-gray-600">No hay candidatos candidatos aún</p>
                        @endforelse
                    </ul>
                </div>
            </div>
